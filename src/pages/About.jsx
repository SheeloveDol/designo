  ...
  return (
    <div className="sm:mx-10 lg:mx-16">
      ...
      <section className="flex flex-col lg:flex-row">
        <div className="h-64 lg:h-auto lg:w-2/5  sm:rounded-t-lg lg:rounded-r-lg lg:rounded-l-none lg:bg-aboutHeroDesktop bg-cover sm:bg-aboutHeroTablet sm:bg-cover  bg-aboutHeroMobile lg:bg-cover ">
          {/*<img src={aboutHeroD}/>*/}
        </div>
        <div className="bg-peach basis-3/5 text-center lg:text-left lg:py-24 lg:px-20 py-12 px-5 text-white sm:rounded-b-lg lg:rounded-l-lg lg:rounded-r-none lg:order-first">
          <h1 className="text-4xl pb-6">About Us</h1>
          <p>
            Founded in 2010, we are a creative agency that produces asting
      ...
      <section className="flex flex-col lg:flex-row sm:mt-32">
        <div className="bg-aboutWorldClassMobile bg-cover bg-center sm:bg-aboutWorldClassTablet lg:bg-aboutWorldClassDesktop lg:bg-center h-64 lg:h-auto lg:order-first sm:rounded-t-lg lg:rounded-l-lg lg:rounded-r-none lg:basis-2/5"></div>
        <div className="bg-[#FFEAE6] text-center py-12 lg:py-40 px-5 text-white sm:rounded-b-lg lg:rounded-r-lg lg:rounded-l-none basis-3/5">
          ...
          <p className="text-darkGrey">
            ...
            Every design is thoughfully crafted from concept to launch, ensuring
            success in its given market. We are constantly updating our skills
            in a myriad of platforms
          </p>

          <p className="text-darkGrey pt-6">
      ...
      <section className="flex flex-col lg:flex-row mt-32">
        <div className="bg-aboutRealDealMobile bg-cover sm:bg-aboutRealDealTablet lg:bg-aboutRealDealDesktop h-64 lg:h-auto sm:rounded-t-lg lg:rounded-r-lg lg:rounded-l-none lg:basis-2/5"></div>
