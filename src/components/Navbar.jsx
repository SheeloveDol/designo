  ...
  return (
    <div className="mx-5 sm:mx-10 lg:mx-16">
      <div className=" flex justify-between py-6 bg-white">
        ...
        <nav onClick={handleOpen} className="sm:w-3/5 md:w-3/5 lg:w-2/5">
          ...
          {/*MOBILE MENU BUTTONS */}
          {open ? (
            <img className="sm:hidden" src={Close} alt="Close menu button" />
          ) : (
            <img className="sm:hidden" src={Hamburger} alt="Menu button" />
          )}
        </nav>
      </div>
    </div>
